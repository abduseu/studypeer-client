...
const ViewAssignment = () => {
    const { title, description, difficulty, marks, image, dueDate } = useLoaderData()
        ...
        <div className="bg-gray rounded-lg">
            ...
            <div className="pb-10 md:pb-20 px-10 md:px-20">
                ...
                <div className="text-center pt-10">
                    <Link to={'/take'}><button className="btn btn-outline btn-neutral">Take Assignment</button></Link>
                </div>
            </div>
        </div>
    );
